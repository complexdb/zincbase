class GraphCaster:
    ...
    def update_edge(self, sub, pred, ob, kb, defer=False):
    ...
    def from_kb(self, kb):
        # TODO check whether this is a generator (ie list of some subset of nodes,
        # e.g. if random > 0.9 to show only 10% of nodes, produced with kb.filter)
        # But then how's that going to handle edges?
